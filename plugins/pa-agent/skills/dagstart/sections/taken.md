...
- Realistic-planning check: name the conflict when meeting-hours and task-hours don't fit in the day — this reads today's agenda slot output, it does not requery the calendar itself.
