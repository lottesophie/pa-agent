...
Status: already real. This slot does **not** get its own sub-skill file — it delegates entirely to the existing `agenda-briefing` skill (`.claude/skills/agenda-briefing/SKILL.md`, story pa-4).
